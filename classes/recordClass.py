...
class Record:
    ...
    def createFileParameters(self):
        ...
        self.stream_df =  DataFrame(data= self.stream_dict)
        ...
        self.TDparams_stream_df =  DataFrame(data= self.TDparams_stream_dict)



        for trace_ind in range(len(self.filedata)):
            trace = self.filedata[trace_ind]
            data =  Series(trace.data)     
            ...
            trace_dict = {"filename": self.filename, 
                    ...
                    "timesec": Series(linspace(0, trace.stats.npts * trace.stats.delta, num=trace.stats.npts, endpoint=False)),
                    "trimmedtimesec": Series(linspace(0, trace.stats.npts * trace.stats.delta, num=trace.stats.npts, endpoint=False)),
